 ...
 */
 // Async load
function blank_theme_async_scripts($url)
{
...
add_filter( 'clean_url', 'blank_theme_async_scripts', 11, 1 );
function blank_theme_scripts() {
	
	wp_deregister_script( 'jquery' );
	wp_enqueue_style( 'blank_theme-style', get_stylesheet_uri() );
	wp_enqueue_script( 'main', get_template_directory_uri() . '/js/main.js', array(), '20180316', true );
	
	wp_enqueue_script( 'fontawesome', 'https://use.fontawesome.com/releases/v5.0.8/js/all.js#asyncload', array(), null, true );
